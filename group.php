<?php
    ...
    if ($info) {
        $db = connectMysql ();
        $query = "SELECT group_name FROM `groups` ORDER BY group_name DESC";
                    ...
                    <table class="table">
                      ...
                      <tbody>
                          ...
                          foreach($result as $key => $value) {
                              echo "<tr>";
                              echo "    <td class=\"group_name\">{$value['group_name']}</td>";
                              echo "    <td><button type=\"button\" class=\"submit btn btn-primary\">선택</button></td>";
                              echo "</tr>";
                          }
                          ?>
                      </tbody>
